...
public interface EmployeeServer extends Remote {
    ...
    ArrayList<Employee> viewAllEmployeesWithPassword() throws RemoteException;

    void updateEmployeeInfo(int UserId, String firstName, String lastName,String password, String email, String address, int phoneNum, String DateOfBirth) throws RemoteException;
